...
-   Inside the IDE, search for "ci_opengl_template" and replace all occurences by the project_name of your choice.
...
-   Update all the badges from the repository by replacing the markdown code with your badge markdown in the README file.
    The differents badge marckdown codes can be found on their respectives website.