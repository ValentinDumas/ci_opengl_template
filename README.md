...
#### Valgrind
....
CTest is used to perform a memory check.
...
#### Visual Studio Compiler Tests
....
CTest is used when testing the code on a Windows platform. 

## Documentation
A code documentation is available at: https://codedocs.xyz/ValentinDumas/ci_opengl_template/
The docs are generated by Codedocs automatically after each push request to Github.
